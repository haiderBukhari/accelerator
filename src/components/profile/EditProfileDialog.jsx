            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        <div className="flex flex-col text-sm leading-4 max-w-[236px] text-neutral-500">
                    ...
                    <div className='mx-3 my-2 mb-5' style={{ borderBottom: "2px solid #ccc" }}></div>
                        <div className='mx-4'>
                            <div className="flex w-full justify-between">
                                <button className='w-[140px] px-10 py-2 rounded-xl text-center text-black bg-[#CCCCCC]'>Cancel</button>
                                <button className='w-[140px] px-10 py-2 rounded-xl text-center text-white bg-[#4C1DBE]'>Save</button>
                            </div>
                        </div>
                    </div>
                </DialogActions>
