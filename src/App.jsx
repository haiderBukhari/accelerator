...
function App() {
  ...
  return (
    <div className={`${currentLocation && 'flex min-h-screen'} bg-[#f2f2f2] md:bg-transparent`}>
      ...
      {(currentLocation && !location.pathname.includes('/dashboard/messages') && location.pathname!== '/dashboard/members' && !location.pathname.includes('/dashboard/course') && location.pathname!=='/dashboard/modules' && !location.pathname.includes('dashboard/details/groups') && !location.pathname.includes('dashboard/course/details') && location.pathname !== '/dashboard/events') ? <AsideSettings /> : null}
