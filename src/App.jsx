  ...
  return (
    <div className='customContainer w-full 2xl:max-w-[2000px] mx-auto'>
      <div className={`${currentLocation && 'flex min-h-screen'} bg-[#f2f2f2] md:bg-transparent`}>
        {currentLocation ? <AsideNavbar navbarOpen={navbarOpen} setNavbarOpen={setNavbarOpen} fetch={fetch} /> : null}
        <div className='w-full pt-0'>
          {location.pathname !== '/home' ? <Routes navbarOpen={navbarOpen} setNavbarOpen={setNavbarOpen} fetch={fetch} setFetch={setFetch} /> : null}
        </div>
